							...
							<div class="col-xs-12">
								...
								<div class="row">
								    ...
								    <div class="col-lg-12">
										...
										<h2 class="col-sm-3" data-rel="tooltip" data-placement="right" title="Crea cuentas de usuario para las personas a cargo de tu hotel. Puedes elegir entre Administrador y Empleado, de acuerdo al rol que deben cumplir. Al agregar un nuevo usuario, una invitación será automáticamente enviada a tu correo electrónico, desde la cual podrá ingresar a tu cuenta.">La empresa</h2>
									</div><!--/span-->
