...
almacen_transferencia.almacen_destino_id = destino.almacen_id AND
almacen_transferencia.transferencia_id <> 1" ;
									...
									<div class="col-xs-12 widget-container-col">
										<div class="widget-box widget-color-blue">
										  <div class="widget-header">
										    ...
										    <h5 class="widget-title"> Lista de devolucion 
										    </h5>
										    ...
										    <div class="widget-toolbar no-border">
										      <button class="btn btn-sm btn-success" id="nuevaDevolucion"> Agregar devolucion </button>
										    </div>
										  </div>

										  <div class="widget-body">
										    <div class="widget-main scrollable" data-size="250">
												<div id="div_listar_devolucions"></div>
												<div id="div_oculto_devolucions" class="none"></div>
										    </div>
										  </div>
										</div>
									</div><!--/span-->
